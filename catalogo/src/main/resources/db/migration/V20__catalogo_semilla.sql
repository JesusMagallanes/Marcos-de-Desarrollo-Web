...
INSERT INTO categoria (name, slug, description, icono) VALUES
    ('Tecnología', 'tecnologia', 'Todo lo que se enchufa, se programa o se juega.', 'microchip');
INSERT INTO categoria (name, slug, description, icono) VALUES
    ('Computación', 'computacion', 'Equipos de trabajo y estudio: portátiles, pantallas y piezas.', 'desktop');
INSERT INTO categoria (name, slug, description, icono) VALUES
    ('Laptops', 'laptops', 'Portátiles para estudiar, trabajar y jugar.', 'laptop');
INSERT INTO categoria (name, slug, description, icono) VALUES
    ('Monitores', 'monitores', 'Pantallas de escritorio, de la ofimática al competitivo.', 'display');
INSERT INTO categoria (name, slug, description, icono) VALUES
    ('Componentes', 'componentes', 'Procesadores, tarjetas gráficas y memoria para armar o mejorar.', 'memory');
INSERT INTO categoria (name, slug, description, icono) VALUES
    ('Almacenamiento', 'almacenamiento', 'Discos sólidos, mecánicos y unidades externas.', 'hard-drive');
INSERT INTO categoria (name, slug, description, icono) VALUES
    ('Periféricos', 'perifericos', 'Lo que se conecta al equipo y se toca todos los días.', 'keyboard');
INSERT INTO categoria (name, slug, description, icono) VALUES
    ('Teclados', 'teclados', 'Mecánicos, de membrana e inalámbricos.', 'keyboard');
INSERT INTO categoria (name, slug, description, icono) VALUES
    ('Mouse', 'mouse', 'Sensores de precisión para oficina y competitivo.', 'computer-mouse');
INSERT INTO categoria (name, slug, description, icono) VALUES
    ('Audio', 'audio', 'Audífonos, diademas y micrófonos.', 'headphones');
INSERT INTO categoria (name, slug, description, icono) VALUES
    ('Móviles', 'moviles', 'Teléfonos y tabletas.', 'mobile-screen');
INSERT INTO categoria (name, slug, description, icono) VALUES
    ('Smartphones', 'smartphones', 'Teléfonos de gama de entrada, media y alta.', 'mobile-screen-button');
INSERT INTO categoria (name, slug, description, icono) VALUES
    ('Tablets', 'tablets', 'Tabletas para leer, dibujar y trabajar fuera del escritorio.', 'tablet-screen-button');
INSERT INTO categoria (name, slug, description, icono) VALUES
    ('Gaming', 'gaming', 'Consolas, sillas y todo lo que rodea al juego.', 'gamepad');
INSERT INTO categoria (name, slug, description, icono) VALUES
    ('Consolas', 'consolas', 'Sobremesa y portátiles, con sus mandos.', 'gamepad');
INSERT INTO categoria (name, slug, description, icono) VALUES
    ('Sillas gamer', 'sillas-gamer', 'Asientos para jornadas largas.', 'chair');
...
INSERT INTO marca (name, descripcion) VALUES ('LG', 'Fabricante surcoreano de electrónica de consumo y paneles.');
INSERT INTO marca (name, descripcion) VALUES ('Samsung', 'Electrónica de consumo, memoria y pantallas.');
INSERT INTO marca (name, descripcion) VALUES ('ASUS', 'Placas, portátiles y equipo para juego bajo la línea ROG.');
INSERT INTO marca (name, descripcion) VALUES ('Acer', 'Portátiles y monitores de gama amplia.');
INSERT INTO marca (name, descripcion) VALUES ('HP', 'Equipos de oficina, portátiles e impresión.');
INSERT INTO marca (name, descripcion) VALUES ('Dell', 'Portátiles y monitores para empresa y hogar.');
INSERT INTO marca (name, descripcion) VALUES ('Lenovo', 'Portátiles ThinkPad, IdeaPad y tabletas.');
INSERT INTO marca (name, descripcion) VALUES ('Apple', 'Ordenadores, teléfonos y tabletas.');
INSERT INTO marca (name, descripcion) VALUES ('Logitech', 'Periféricos de precisión para oficina y juego.');
INSERT INTO marca (name, descripcion) VALUES ('Razer', 'Periféricos y portátiles orientados al competitivo.');
INSERT INTO marca (name, descripcion) VALUES ('Corsair', 'Memoria, refrigeración y periféricos mecánicos.');
INSERT INTO marca (name, descripcion) VALUES ('HyperX', 'Audio y teclados con foco en juego.');
INSERT INTO marca (name, descripcion) VALUES ('Xiaomi', 'Teléfonos y ecosistema conectado.');
INSERT INTO marca (name, descripcion) VALUES ('Sony', 'Audio, imagen y consolas PlayStation.');
INSERT INTO marca (name, descripcion) VALUES ('Redragon', 'Periféricos de juego de precio ajustado.');
INSERT INTO marca (name, descripcion) VALUES ('Kingston', 'Memoria RAM y unidades de estado sólido.');
INSERT INTO marca (name, descripcion) VALUES ('Western Digital', 'Almacenamiento mecánico y sólido.');
INSERT INTO marca (name, descripcion) VALUES ('Seagate', 'Discos duros de sobremesa y externos.');
INSERT INTO marca (name, descripcion) VALUES ('AMD', 'Procesadores Ryzen y gráficas Radeon.');
INSERT INTO marca (name, descripcion) VALUES ('Intel', 'Procesadores Core y gráficas Arc.');
INSERT INTO marca (name, descripcion) VALUES ('NVIDIA', 'Tarjetas gráficas GeForce.');
INSERT INTO marca (name, descripcion) VALUES ('Nintendo', 'Consolas y videojuegos.');
INSERT INTO marca (name, descripcion) VALUES ('Microsoft', 'Consolas Xbox y accesorios.');
INSERT INTO marca (name, descripcion) VALUES ('Cougar', 'Sillas y mobiliario para juego.');
INSERT INTO marca (name, descripcion) VALUES ('Secretlab', 'Sillas ergonómicas de gama alta.');
...
INSERT INTO atributo (codigo, nombre, unidad, tipo, filtrable) VALUES
    ('pulgadas', 'Tamaño de pantalla', 'pulgadas', 'NUMERO', TRUE);
INSERT INTO atributo (codigo, nombre, unidad, tipo, filtrable) VALUES
    ('resolucion', 'Resolución', NULL, 'TEXTO', TRUE);
INSERT INTO atributo (codigo, nombre, unidad, tipo, filtrable) VALUES
    ('refresco_hz', 'Tasa de refresco', 'Hz', 'NUMERO', TRUE);
INSERT INTO atributo (codigo, nombre, unidad, tipo, filtrable) VALUES
    ('panel', 'Tipo de panel', NULL, 'TEXTO', TRUE);
INSERT INTO atributo (codigo, nombre, unidad, tipo, filtrable) VALUES
    ('procesador', 'Procesador', NULL, 'TEXTO', TRUE);
INSERT INTO atributo (codigo, nombre, unidad, tipo, filtrable) VALUES
    ('ram_gb', 'Memoria RAM', 'GB', 'NUMERO', TRUE);
INSERT INTO atributo (codigo, nombre, unidad, tipo, filtrable) VALUES
    ('almacenamiento_gb', 'Almacenamiento', 'GB', 'NUMERO', TRUE);
INSERT INTO atributo (codigo, nombre, unidad, tipo, filtrable) VALUES
    ('tipo_almacenamiento', 'Tipo de unidad', NULL, 'TEXTO', TRUE);
INSERT INTO atributo (codigo, nombre, unidad, tipo, filtrable) VALUES
    ('sistema_operativo', 'Sistema operativo', NULL, 'TEXTO', TRUE);
INSERT INTO atributo (codigo, nombre, unidad, tipo, filtrable) VALUES
    ('grafica', 'Tarjeta gráfica', NULL, 'TEXTO', TRUE);
INSERT INTO atributo (codigo, nombre, unidad, tipo, filtrable) VALUES
    ('color', 'Color', NULL, 'TEXTO', TRUE);
INSERT INTO atributo (codigo, nombre, unidad, tipo, filtrable) VALUES
    ('conectividad', 'Conectividad', NULL, 'TEXTO', FALSE);
INSERT INTO atributo (codigo, nombre, unidad, tipo, filtrable) VALUES
    ('tipo_switch', 'Tipo de switch', NULL, 'TEXTO', TRUE);
INSERT INTO atributo (codigo, nombre, unidad, tipo, filtrable) VALUES
    ('sensor_dpi', 'Sensor', 'DPI', 'NUMERO', TRUE);
INSERT INTO atributo (codigo, nombre, unidad, tipo, filtrable) VALUES
    ('inalambrico', 'Inalámbrico', NULL, 'BOOLEANO', TRUE);
INSERT INTO atributo (codigo, nombre, unidad, tipo, filtrable) VALUES
    ('cancelacion_ruido', 'Cancelación de ruido', NULL, 'BOOLEANO', TRUE);
INSERT INTO atributo (codigo, nombre, unidad, tipo, filtrable) VALUES
    ('bateria_mah', 'Batería', 'mAh', 'NUMERO', FALSE);
INSERT INTO atributo (codigo, nombre, unidad, tipo, filtrable) VALUES
    ('camara_mp', 'Cámara principal', 'MP', 'NUMERO', TRUE);
INSERT INTO atributo (codigo, nombre, unidad, tipo, filtrable) VALUES
    ('peso_kg', 'Peso', 'kg', 'NUMERO', FALSE);
INSERT INTO atributo (codigo, nombre, unidad, tipo, filtrable) VALUES
    ('garantia_meses', 'Garantía', 'meses', 'NUMERO', FALSE);
INSERT INTO atributo (codigo, nombre, unidad, tipo, filtrable) VALUES
    ('capacidad_kg', 'Capacidad de carga', 'kg', 'NUMERO', FALSE);
INSERT INTO atributo (codigo, nombre, unidad, tipo, filtrable) VALUES
    ('material', 'Material', NULL, 'TEXTO', FALSE);
