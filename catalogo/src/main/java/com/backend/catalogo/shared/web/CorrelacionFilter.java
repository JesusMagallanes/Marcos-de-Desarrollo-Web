package com.backend.catalogo.shared.web;
...
/**
 * A09: propaga el identificador de correlación que trae el llamante para poder
 * seguir una compra a través de gateway → compras → catálogo en los registros.
 */
@Component
