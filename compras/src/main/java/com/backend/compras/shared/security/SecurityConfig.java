...
import com.backend.compras.shared.seguridad.CabecerasSeguridad;
...
public class SecurityConfig {
    ...
    /** A02/A08: se valida firma, caducidad, emisor y audiencia. */
    @Bean
    ...
    SecurityFilterChain filterChain(HttpSecurity http, JwtAuthenticationConverter convertidor,
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // El webhook lo llama MercadoPago, no el navegador: se valida
                        // por firma dentro del controlador, no por JWT.
