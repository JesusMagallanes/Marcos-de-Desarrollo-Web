 ...
 * migración futura que haga INSERT o UPDATE sobre `usuario`,
 * `solicitud_colaborador`, `documento_identidad` y demás vería cero filas y se
 * daría por buena sin hacer nada. Esa migración debe empezar por:
 *
